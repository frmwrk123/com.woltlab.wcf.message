...
//<![CDATA[
	...
	var __CKEDITOR_BUTTONS = [ {implode from=$__wcf->getBBCodeHandler()->getButtonBBCodes() item=__bbcode}{ icon: '{$__bbcode->wysiwygIcon}', label: '{$__bbcode|language}', name: '{$__bbcode->bbcodeTag}' }{/implode} ];
//]]>
</script>
